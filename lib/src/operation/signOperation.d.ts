 ...
 */
export declare function signOperation<T extends State & StateHead & StateOperation>(state: T): Observable<T & State & StateHead & StateOperation & StateSignOperation>;
/**
 * Sign operation using hardware Trezor wallet
 * @param state transaction state
 * @throws Typerror when operation is not available
 */
export declare function signOperationTrezor<T extends State & StateHead & StateOperation>(state: T): Observable<T & State & StateHead & StateOperation & StateSignOperation>;
