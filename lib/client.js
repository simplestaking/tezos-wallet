 ...
 */
export const transfer = (fn) => (source) => source.pipe(map(state => (Object.assign({}, state, fn(state)))), 
 ...
 */
export const setDelegation = (fn) => (source) => source.pipe(map(state => (Object.assign({}, state, fn(state)))), 
// get contract counter
counter(), 
// get contract managerKey
managerKey(), 
