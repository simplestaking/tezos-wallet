...
exports.signOperationTrezor = function (state) {
    var trezorPopup = new Promise(function (resolve, reject) {
        ...
        console.log('[to]', exports.bs58checkDecode(prefix.tz1, state.to));
        console.log('[from]', exports.bs58checkDecode(prefix.tz1, state.publicKeyHash));
        console.log('[to]', exports.bs58checkDecode(prefix.B, state.head.hash));
        var hash = exports.bs58checkDecode(prefix.B, state.head.hash);
        var source = exports.concatKeys(new Uint8Array([0]), exports.bs58checkDecode(prefix.tz1, state.publicKeyHash));
        var to = exports.concatKeys(new Uint8Array([0]), exports.bs58checkDecode(prefix.tz1, state.to));
