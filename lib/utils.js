    ...
    let trezorPopup = new Promise(function (resolve, reject) {
        ...
        state.operations.map((operation) => {
            ...
            if (operation.kind === 'origination') {
                debugger;
                console.log(Buffer.from(JSON.stringify(operation.script), 'utf8'));
                message = Object.assign({}, message, { 
        ...
        TrezorConnect.tezosSignTx(message)
            ...
            resolve(Object.assign({}, state, { signature: response.payload.signature, signedOperationContents: response.payload.sig_op_contents, operationHash: response.payload.operation_hash }));
        });
    });
